...
## 開発にあたって
ADHD（注意欠如、多動性障害）を持つ知り合いを分析していたところ、タスク管理が苦手なようだったので、それを補助できそうな機能をつけたタスク管理アプリを試しに開発してみました。

- ADHDを持つ人々は前頭前野の機能不全により、タスクの工程の想像、タスク管理、タスク遂行において苦手意識を持ちます。
- タスク自体をAIを使い自動作成することによって、タスクの工程の洗い出し、タスク入力の手間を省くことができます。これにより、ADHDを持つ人でも負担が少なくタスク管理アプリを使用することができます。
- タスクの作業見積もり時間を生成することにより、タスクにかかる時間を想定することが苦手な人の補助になります。
- タスクを効率的、効果的に達成するためのアドバイスを生成することにより、タスクを効率よくこなすことを苦手とする人の生産性を上げることができます。
